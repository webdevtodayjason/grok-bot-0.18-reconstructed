...
export const sendToAgentParameters = z.object({
  target_id: z.string().trim().min(1).describe(
    "The id of the target — either another agent or a GROUP you belong to. Use an id from your teammates list — not a name.",
  ),

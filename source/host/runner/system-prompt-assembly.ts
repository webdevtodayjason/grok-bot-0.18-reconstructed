...
export interface SystemPromptAssemblyDependencies {
   ...
   * toolset only offers those five while a computer answers, so the prompt has to swing on the
   * same fact or the model is coached at length on tools it does not have.
   */

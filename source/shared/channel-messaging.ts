import { SAND_PRODUCT_NAME } from "./product-name.js";
...
export function renderChannelsSystemPrompt(
  ...
  const lines = [
    `Channels: outside messaging surfaces you can talk on, beyond this ${SAND_PRODUCT_NAME} chat.`,

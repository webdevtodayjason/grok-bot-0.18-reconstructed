...
`;
  ...
  function voiceCardMarkup() {
    return `<section class="settings-section" ${CARD_ATTRIBUTE}><h3>Talking</h3>`
      ...
      + `<div class="voice-grid"><label>Service<select data-voice-vendor></select></label><label>Model<input type="text" autocomplete="off" data-voice-model /></label><label>Voice<input type="text" autocomplete="off" data-voice-voice /></label></div>`

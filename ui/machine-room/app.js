(function startWarmwindPrototype() {
   ...
   *
   * ONE structural change: the wrapper is .settings-operator-list and no longer .settings-list.
   * That class is now the Notifications body's alone, which is push-settings.js's whole mount
   * contract -- a second .settings-list on the page would put that card in two places.
   */

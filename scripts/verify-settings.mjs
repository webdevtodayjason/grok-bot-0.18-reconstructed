...
try {
  ...
  // printed against the one measured with the gallery inline rather than left inside a total. Item B's
  // own legs do not move it; item C's Choose control does, and the two numbers meet here.
  ...
  // =================================================================================================
  step("General's own height at this viewport, now that the gallery is behind a Choose control");
  // =================================================================================================
